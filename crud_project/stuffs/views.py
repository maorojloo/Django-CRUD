...
def etc_list(request):
    ...
    return render(request,'etc.html',{'cpus':cpus,'form':form})
...
class SearchResultsView(ListView):
    ...
    def get_queryset(self): # new
        ...
        object_list = etc.objects.filter(Q(name__icontains=query) | Q(etc__icontains=query))
        messages.info(self.request,"the search result for {"+query+"}")
        return object_list
